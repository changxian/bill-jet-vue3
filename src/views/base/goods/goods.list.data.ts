...
export const stockOptions = {
  mode1: [{ code: '1', name: '增加库存' }, { code: '2', name: '减少库存' }],
  mode1Map: {
    1: [
      // { code: '110', name: '初始入库' }, { code: '120', name: '进货增加' }, { code: '130', name: '销售退货增加' },
      { code: '140', name: '调入增加' }, { code: '150', name: '报溢增加' }, { code: '190', name: '其他增加' }],
    2: [
      // { code: '210', name: '销货减少' }, { code: '220', name: '进货退货减少' },
      { code: '230', name: '调出减少' }, { code: '240', name: '报损减少' }, { code: '290', name: '其他减少' }]
  },
  mode2: [],
};
