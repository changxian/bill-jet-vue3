                        ...
                        <div class="aui-flex">
                          <div class="aui-flex-box">
                            <div class="aui-third-login" style="margin-top: 8px; margin-bottom: 12px">
                              <label style="display: flex; font-size: 14px; cursor: pointer" ><input style="margin-right: 10px; width: 15px;" type="radio" value="1" v-model="formData.businessType"/>销售单</label>
                            </div>
                          </div>
                          <div class="aui-flex-box">
                            <div class="aui-third-login" style="margin-top: 8px; margin-bottom: 12px">
                              <label style="display: flex; font-size: 14px; cursor: pointer" ><input style="margin-right: 10px; width: 15px;" type="radio" value="2" v-model="formData.businessType"  />进销存</label>
                            </div>
                          </div>
                        </div>
                      </div>-->
                ...
                <div class="aui-flex" :class="`${prefixCls}-sign-in-way`">
                  <div class="aui-flex-box">
                    <div class="aui-third-login">
                      <a title="销售单版" href="javascript:void(0);" @click="demoLogin('1')">销售单</a>
                    </div>
                  </div>
                  <div class="aui-flex-box">
                    <div class="aui-third-login">
                      <a title="进销存版" href="javascript:void(0);" @click="demoLogin('2')">进销存</a>
                    </div>
                  </div>
                </div>
              </a-form>
