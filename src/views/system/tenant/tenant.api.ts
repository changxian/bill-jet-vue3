...
enum Api {
  ...
  tenantPackExtension = '/sys/tenant/tenantPackExtension',
 ...
 * @param params
 */
export const tenantPackExtension = (params) => {
  return defHttp.post({ url: Api.tenantPackExtension, params }, { isTransformResponse: false });
};
