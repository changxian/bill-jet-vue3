...
<script lang="ts" setup>
  ...
  const mockData = [
    { id: '000', sort: 0, filePath: '/src/assets/test/1_1588149743473.jpg' },
    { id: '111', sort: 1, filePath: '/src/assets/test/u27356337152749454924fm27gp0_1588149731821.jpg' },
    { id: '222', sort: 2, filePath: '/src/assets/test/u24454681402491956848fm27gp0_1588149712663.jpg' },
    { id: '333', sort: 3, filePath: '/src/assets/test/国炬软件logo_1606575029126.png' },
    { id: '444', sort: 4, filePath: '/src/assets/test/u8891206113801177793fm27gp0_1588149704459.jpg' },
  ];
