...
<script lang="ts">
  ...
  const imgList: ImageProps[] = [
    { src: '/src/assets/test/login_1658829954004.png', width: 300 },
    { src: '/src/assets/test/home_index_1658830084684.png', width: 300 },
    { src: '/src/assets/test/design_1658830200539.png', width: 300 },
    { src: '/src/assets/test/13_1592320121058.png', width: 300 },
    { src: '/src/assets/test/16_1592320251436.png', width: 300 },
  ];
