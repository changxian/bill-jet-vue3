      ...
      <template #detail>
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol" name="CustomerForm">
          <a-row>
						...
						<a-col :span="24">
							<a-form-item label="业务员" v-bind="validateInfos.userName" id="CustomerForm-userName" name="userName">
								<j-dict-select-tag v-model:value="formData.userName" :url="getAllSalesmanList" placeholder="请选择业务员"  allow-clear />
							</a-form-item>
						</a-col>
						<a-col :span="24">
