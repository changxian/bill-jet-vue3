...
enum Api {
  ...
  listCount = '/deliver/debtdetail/deliverDebtDetail/listCount',
  ...
  importExcel = '/bill/deliver/debtdetail/deliverDebtDetail/importExcel',
  exportXls = '/deliver/debtdetail/deliverDebtDetail/exportXls',
}
