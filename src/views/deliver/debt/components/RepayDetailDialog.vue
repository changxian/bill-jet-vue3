    ...
    <div style="padding:20px 30px">
      <div class="p-2">
                ...
                <a-col :lg="4">
                  <a-form-item label="类型" name="type">
                    <a-select v-model:value="queryParam.type">
                      ...
                      <a-select-option value="3">销售还款</a-select-option>
                      <a-select-option value="2">退货还款</a-select-option>
                    </a-select>
                  </a-form-item>
                </a-col>
              </template>
              <a-col :xl="4" :lg="4" :md="6" :sm="12">
        ...
        <BasicTable @register="registerTable" :rowSelection="rowSelection" @row-click="rowClick">
          <!--插槽:table标题-->
          <template #tableTitle>
            <a-button type="primary" v-auth="'deliver.bill:jxc_deliver_bill:add'"
...
<script lang="ts" setup>
  ...
  import { getExportUrl, repayDetailList, deliverRepayList, repayRevoke } from '../DeliverDebt.api';
  import { JInput } from '@/components/Form';
  import FastDate from '/@/components/FastDate.vue';
  import { useMessage } from '/@/hooks/web/useMessage';
  import RepayEditDialog from './RepayEditDialog.vue';
