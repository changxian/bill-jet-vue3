<template>
  <j-modal title="送货欠款还款" width="700px" maxHeight="400px" :visible="visible" @ok="handleOk"
           @cancel="handleCancel"
           cancelText="关闭">
          ...
          <a-row>
            ...
            <a-col :span="span">
              <a-form-item label="还款日期" v-bind="validateInfos.billDate"
                           id="DeliverBillForm-billDate" name="billDate">
                <a-date-picker
                  placeholder="请选择还款日期"
            ...
            <a-col :span="24">
              <a-form-item label="欠款单号" v-bind="validateInfos.billNo"
                           id="DeliverDebtForm-billNo" name="billNo">
            ...
            <a-col :span="24">
              <a-form-item label="需还款总额" v-bind="validateInfos.debtAmount"
                           id="DeliverDebtForm-deliverDebtAmount" name="debtAmount">
            ...
            <a-col :span="24">
              <a-form-item label="还款金额" v-bind="validateInfos.repayAmount"
                           id="DeliverDebtForm-repayAmount" name="repayAmount">
            ...
            <a-col :span="24">
              <a-form-item label="公司名称" v-bind="validateInfos.collectCompanyId"
                           id="DeliverBillForm-collectCompanyId" name="collectCompanyId">
            ...
            <a-col :span="24">
              <a-form-item label="操作员" v-bind="validateInfos.userName"
                           id="DeliverDebtForm-userName" name="userName">
            ...
            <a-col :span="24">
              <a-form-item label="备注" v-bind="validateInfos.remark" id="DeliverDebtForm-remark"
                           name="remark">
...
import {repay} from "@/views/deliver/debt/DeliverDebt.api";
