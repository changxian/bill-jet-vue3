<template>
  <div class="p-2">
    ...
    <!-- 表单区域 -->
    <SupplierBillModal ref="registerModal" @success="handleSuccess"></SupplierBillModal>
  </div>
</template>

<script lang="ts" name="inoutbill-supplierBill" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns, superQuerySchema } from './SupplierBill.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './SupplierBill.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import SupplierBillModal from './components/SupplierBillModal.vue'
