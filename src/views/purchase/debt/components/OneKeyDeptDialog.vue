 <template>
    ...
    <div style="padding:20px 30px">
          ...
          <a-row>
            ...
            <a-col :span="24">
							<a-form-item label="退货欠款" v-bind="validateInfos.returnDebtAmount" id="PurchaseDebtForm-purchaseDebtAmount" name="returnDebtAmount">
								<a-input-number v-model:value="formData.returnDebtAmount" placeholder="请输入退货欠款金额" style="width: 100%" />
							</a-form-item>
						</a-col>
            <a-col :span="24">
							<a-form-item label="进货欠款" v-bind="validateInfos.purchaseDebtAmount" id="PurchaseDebtForm-purchaseDebtAmount" name="purchaseDebtAmount">
								<a-input-number v-model:value="formData.purchaseDebtAmount" placeholder="请输入需还款总额" style="width: 100%" />
							</a-form-item>
						</a-col>
						<a-col :span="24">
