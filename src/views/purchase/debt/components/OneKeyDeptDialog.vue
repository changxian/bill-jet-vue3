          ...
          <a-row>
            ...
            <a-col :span="24">
              <a-form-item label="退货欠款" v-bind="validateInfos.returnDebtAmount"
                ...
                <a-input-number v-model:value="formData.returnDebtAmount"
            ...
            <a-col :span="24">
              <a-form-item label="进货欠款" v-bind="validateInfos.purchaseDebtAmount"
                ...
                <a-input-number v-model:value="formData.purchaseDebtAmount"
...
import {oneKeyRepay, repay} from "@/views/purchase/debt/PurchaseDebt.api";
