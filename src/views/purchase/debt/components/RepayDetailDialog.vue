 <template>
    <j-modal title="还款明细"  width="1000px"  :fullscreen="true" maxHeight="800px" :visible="visible"  @cancel="handleCancel">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection" @row-click="rowClick">
      ...
      <template #tableTitle>
        ...
        <a-button type="primary" v-auth="'purchase.bill:jxc_purchase_bill:add'"  @click="handleEdit" preIcon="ant-design:edit-outlined"> 撤回</a-button>
