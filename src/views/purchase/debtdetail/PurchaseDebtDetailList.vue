          ...
          <template v-if="toggleSearchStatus">
            <a-col :lg="6">
              <a-form-item name="type">
                ...
                <a-select v-model:value="queryParam.type">
                  ...
                  <a-select-option value="1">进货欠款</a-select-option>
            ...
            <a-col :lg="6">
              <a-form-item name="createName">
                ...
                <a-input placeholder="请输入制单人" v-model:value="queryParam.ctName" allow-clear></a-input>
              </a-form-item>
            </a-col>
            <!--<a-col :lg="6">
...
<script lang="ts" name="purchase.debtdetail-purchaseDebtDetail" setup>
  ...
  import { columns } from './PurchaseDebtDetail.data';
  import { list, listCount, getExportUrl } from './PurchaseDebtDetail.api';
  ...
  const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
    tableProps: {
      ...
      beforeFetch: async (params) => {
        ...
        return Object.assign(params, queryParam, fastDateParam, { supplierId: supplierId.value });
      },
