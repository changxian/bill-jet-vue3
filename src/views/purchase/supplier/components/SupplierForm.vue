    ...
    <JFormContainer :disabled="disabled">
      <template #detail>
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol"
          ...
          <a-row>
            <a-col :span="12">
              <a-form-item label="供应商名称" v-bind="validateInfos.orgName"
                           id="SupplierForm-orgName" name="orgName">
                <a-input v-model:value="formData.orgName" placeholder="请输入供应商名称"
                         allow-clear></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="手机" v-bind="validateInfos.cellPhone" id="SupplierForm-cellPhone"
                           name="cellPhone">
                <a-input v-model:value="formData.cellPhone" placeholder="请输入手机"
                         allow-clear></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="电话" v-bind="validateInfos.phone" id="SupplierForm-phone"
                           name="phone">
            ...
            <a-col :span="12">
              <a-form-item label="联系人" v-bind="validateInfos.contact" id="SupplierForm-contact"
                           name="contact">
            ...
            <a-col :span="12">
              <a-form-item label="地址" v-bind="validateInfos.address" id="SupplierForm-address"
                           name="address">
            ...
            <a-col :span="12">
              <a-form-item label="传真" v-bind="validateInfos.faxes" id="SupplierForm-faxes"
                           name="faxes">
                <a-input v-model:value="formData.faxes" placeholder="请输入传真"
                         allow-clear></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
            ...
            <a-col :span="12">
              <a-form-item label="微信" v-bind="validateInfos.wechat" id="SupplierForm-wechat"
                           name="wechat">
                <a-input v-model:value="formData.wechat" placeholder="请输入微信"
                         allow-clear></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="邮箱" v-bind="validateInfos.email" id="SupplierForm-email"
                           name="email">
          ...
          <a-row>
            <span
              style="position: relative; margin-bottom: 20px; margin-left: 5.1%">更多信息（在系统参数中配置）</span>
          </a-row>
          <a-row v-if="formData.dynamicFields && 0 < formData.dynamicFields.length" :gutter="10">
            <a-col v-for="(item, index) in formData.dynamicFields" :key="item.id" :span="12">
              ...
              >
                <a-input v-model:value="formData.dynamicFields[index].fieldValue"
                         :placeholder="'请输入' + item.fieldTitle" allow-clear/>
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
