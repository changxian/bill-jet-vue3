((e, n) => {
  ...
  if (!r.jWeixin) return a = {
    ...
    for (e in a) n[a[e]] = e;
    return n
  })(), i = (n = r.document).title, t = navigator.userAgent.toLowerCase(), f = navigator.platform.toLowerCase(),
    s = !(!f.match("mac") && !f.match("win")), d = -1 != t.indexOf("wxdebugger"), o = -1 != t.indexOf(
    ...
    config: function (e) {
      ...
      B(function () {
        if (o) k(a.config, {
          ...
          var n;
          s || d || h.debug || p < "6.0.2" || g.systemType < 0 || (n =
            new Image, g.appId = h.appId, g.initTime = m.initEndTime -
            m.initStartTime, g.preVerifyTime = m.preVerifyEndTime -
            m.preVerifyStartTime, _.getNetworkType({
            isInnerInvoke: !0,
            success: function (e) {
              g.networkType = e.networkType, n.src =
                "https://open.weixin.qq.com/sdk/report?v=" +
                g.version + "&o=" + g.isPreVerifyOk +
                "&s=" + g.systemType + "&c=" +
                g.clientVersion + "&a=" + g.appId +
                "&n=" + g.networkType + "&i=" +
                g.initTime + "&p=" + g.preVerifyTime +
                "&u=" + g.url
            }
          }))
    ...
    launchMiniProgram: function (e) {
      k("launchMiniProgram", {
        ...
        path: (e => {
          var n;
          if ("string" == typeof e && 0 < e.length) return n = e.split("?")[0],
            n += ".html", void 0 !== (e = e.split("?")[1]) ? n + "?" +
            e : n
        })(e.path),
    ...
    var n;
    l || (n = (e = e.target).tagName, "IMG" != n && "VIDEO" != n && "AUDIO" != n && "SOURCE" != n) ||
    (n = e["wx-id"]) && (T[n] = !1)
    ...
    var t = n.errMsg,
      e = (t || (t = n.err_msg, delete n.err_msg, t = ((e, n) => {
        ...
        return t && (e = t), t = "ok", n && (i = n.indexOf(":"), "access denied" != (t = (t = (
          t = -1 != (t = -1 != (t = "failed" == (t = "confirm" == (t = n.substring(
            i + 1)) ? "ok" : t) ? "fail" : t).indexOf("failed_") ? t.substring(
            7) : t).indexOf("fail_") ? t.substring(5) : t).replace(/_/g,
          " ")).toLowerCase()) && "no permission to execute" != t || (t =
          "permission denied"), "" == (t = "config" == e && "function not exist" == t ?
          "ok" : t)) && (t = "fail"), n = e + ":" + t
