...
var hiArray = [
    ...
    var i = function () {
      ...
      m = function () {
        ...
        return t.prototype.init = function () {
            ...
            (o.columns || []).filter(function (column) {return column.checked}).forEach(function (o, a) {
              if (o.getTarget().attr("haswidth")) {
                ...
                n.length > 0 && (n[n.length - 1].nextGrip = s), n.push(s), t.syncGrips(o, s), $(p).hidraggable({
                  ...
                  minMove: 1,
                  getScale: function getScale() {
                    let _hiprint_printPaper = $('.hiprint-printPaper');
                    if (!_hiprint_printPaper
                      || !_hiprint_printPaper.length || !_hiprint_printPaper[0].style
                      || _hiprint_printPaper[0].style.transform
                      || !parseFloat(_hiprint_printPaper[0].style.transform.slice(6, -1))) {
                      return 1;
                    }
                    return (_hiprint_printPaper[0].style.transform && parseFloat(_hiprint_printPaper[0].style.transform.slice(6, -1)));
                  },
                  onBeforeDrag: function onBeforeDrag(t) {
          ...
          var n = t.getTarget();
          var scale = 1;
          var _hiprint_printPaper = $('.hiprint-printPaper');
          if (!(!_hiprint_printPaper
            || !_hiprint_printPaper.length || !_hiprint_printPaper[0].style
            || _hiprint_printPaper[0].style.transform
            || !parseFloat(_hiprint_printPaper[0].style.transform.slice(6, -1)))) {
            scale = (_hiprint_printPaper[0].style.transform && parseFloat(_hiprint_printPaper[0].style.transform.slice(6, -1)))
          }
  ...
  function (t, e, n) {
    ...
    var _r,
      ...
      pt = function () {
        ...
        return t.prototype.design = function (t) {
          ...
          // 更新自定义页码
          if (a[0] && a[0].innerHTML) a[0].innerHTML = a[0].innerHTML.replaceAll('innerPaperCount', hinnn._paperList.length);
    ...
    function getPrinterList(c) {
      p.a.instance.clear("printerList");
      p.a.instance.on("getPrinterList", c);
