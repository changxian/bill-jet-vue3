...
<script lang="ts">
  ...
  import CustomerSelectModal from './modal/CustomerSelectModal.vue';
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      function setValue(options, values, rowSelection) {
        ...
        // console.log('values:====', values, 'selectOptions.value:', selectOptions.value)
