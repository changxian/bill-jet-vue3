  ...
  <div class="JselectSalesman">
    ...
    <a-form-item>
      <SalesmanSelectModal
        ...
        v-bind="getBindValue"
        :excludeSalesmanIdList="excludeSalesmanIdList"
        @close="handleClose"
      />
    </a-form-item>
...
<script lang="ts">
  ...
  import SalesmanSelectModal from './modal/SalesmanSelectModal.vue';
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      //表单值
      // const [state] = SalesmanuleFormItem(props, 'value', 'change', emitData);
      //下拉框选项值
      ...
      //update-begin---author:wangshuai ---date:20230703  for：【QQYUN-5685】5、离职人员可以选自己------------
      const excludeSalesmanIdList = ref<any>([]);
      
      /**
       * 需要监听一下excludeSalesmanIdList，否则modal获取不到
       */ 
      watch(()=>props.excludeSalesmanIdList,(data)=>{
        excludeSalesmanIdList.value = data;
      },{ immediate: true })
      //update-end---author:wangshuai ---date:20230703  for：【QQYUN-5685】5、离职人员可以选自己------------
